...
Last updated: 2026-06-12 · Branch: `p1-telegram-sell-reduce-alerts` (P1-4b — alertas defensivas Telegram + recordatorio REDUCE)
...
| Test runner | `npx tsx scripts/run-tests.ts` (not Jest) — 26 suites, 1563 asserts |
